...
package org.catbird.animation
{
    ...
    public class Tween extends EventDispatcher implements IAnimatable
    {
        ...
        /** @private */
        catbird_internal static function fromPool(target:Object, time:Number, 
        ...
        /** @private */
        catbird_internal static function toPool(tween:Tween):void
        {
