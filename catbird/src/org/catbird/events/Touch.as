...
package org.catbird.events
{
    import flash.geom.Matrix;
    import flash.geom.Point;
    
    import org.catbird.core.catbird_internal;
    import org.catbird.display.DisplayObject;
    import org.catbird.utils.MatrixUtil;
    import org.catbird.utils.formatString;
    
    use namespace catbird_internal;
    ...
    public class Touch
    {
         ...
         *  a target is set). */
        catbird_internal function dispatchEvent(event:TouchEvent):void
        {
            if (mTarget) event.dispatch(mBubbleChain);
        }
        
        /** @private */
        catbird_internal function get bubbleChain():Vector.<EventDispatcher>
        {
            return mBubbleChain.concat();
        }
        
        /** @private */
        catbird_internal function setTarget(value:DisplayObject):void 
        { 
            mTarget = value;
            updateBubbleChain();
        }
        ...
        /** @private */
        catbird_internal function setPosition(globalX:Number, globalY:Number):void
        {
        ...
        /** @private */
        catbird_internal function setSize(width:Number, height:Number):void 
        { 
            mWidth = width;
            mHeight = height;
        }
        ...
        /** @private */
        catbird_internal function setPhase(value:String):void { mPhase = value; }
        
        /** @private */
        catbird_internal function setTapCount(value:int):void { mTapCount = value; }
        
        /** @private */
        catbird_internal function setTimestamp(value:Number):void { mTimestamp = value; }
        
        /** @private */
        catbird_internal function setPressure(value:Number):void { mPressure = value; }
    }
}