...
package org.catbird.core
{
    ...
    public class RenderSupport
    {
        ...
        public function set renderTarget(target:Texture):void 
        {
            ...
            if (target) Catbird.context.setRenderToTexture(target.base);
            else        Catbird.context.setRenderToBackBuffer();
        }
                                            ...
                                            enableDepthAndStencil:Boolean):void
        {
            ...
            Catbird.context.configureBackBuffer(width, height, antiAlias, enableDepthAndStencil);
        }
        ...
        public function set scissorRectangle(value:Rectangle):void
        {
            if (value)
            {
                ...
                Catbird.context.setScissorRectangle(sRectangle);
            }
            else 
            {
                mScissorRectangle.setEmpty();
                Catbird.context.setScissorRectangle(null);
            }
        }
        ...
        public static function setBlendFactors(premultipliedAlpha:Boolean, blendMode:String="normal"):void
        {
            ...
            Catbird.context.setBlendFactors(blendFactors[0], blendFactors[1]);
        }
        
        /** Clears the render context with a certain color and alpha value. */
        public static function clear(rgb:uint=0, alpha:Number=0.0):void
        {
            Catbird.context.clear(
