...
package org.catbird.core
{
    ...
    import org.catbird.animation.Juggler;
    import org.catbird.display.DisplayObject;
    import org.catbird.display.Stage;
    import org.catbird.events.EventDispatcher;
    import org.catbird.events.ResizeEvent;
    ...
    [Event(name="context3DCreate", type="org.catbird.events.Event")]
    
    /** Dispatched when the root class has been created. */
    [Event(name="rootCreated", type="org.catbird.events.Event")]
     ...
     * 
     */ 
    public class Catbird extends EventDispatcher
    {
        ...
        private static var sCurrent:Catbird;
         ...
         */
        public function Catbird(rootClass:Class, stage:flash.display.Stage, 
        ...
        private function initializeGraphicsAPI():void
        {
            ...
            dispatchEventWith(org.catbird.events.Event.CONTEXT3D_CREATE, false, mContext);
        }
        ...
        private function initializeRoot():void
        {
            if (mRoot == null)
            {
                ...
                dispatchEventWith(org.catbird.events.Event.ROOT_CREATED, false, mRoot);
            }
        }
        ...
        {
            if (!Catbird.handleLostContext && mContext)
            {
                stop();
        ...
        private function onKey(event:KeyboardEvent):void
        {
            ...
            makeCurrent();
            mStage.dispatchEvent(new org.catbird.events.KeyboardEvent(
        ...
        public function showStatsAt(hAlign:String="left", vAlign:String="top", scale:Number=1):void
        {
            if (mContext == null)
            {
                ...
                addEventListener(org.catbird.events.Event.ROOT_CREATED, onRootCreated);
            }
            else
            {
            ...
            function onRootCreated():void
            {
                ...
                removeEventListener(org.catbird.events.Event.ROOT_CREATED, onRootCreated);
            }
        }
        ...
        public static function get current():Catbird { return sCurrent; }
