...
package org.catbird.filters
{
    ...
    import org.catbird.display.QuadBatch;
    ...
    import org.catbird.utils.getNextPowerOfTwo;
    ...
    public class FragmentFilter
    {
                                      ...
                                      parentAlpha:Number, intoCache:Boolean=false):QuadBatch
        {
            ...
            var scale:Number = Catbird.current.contentScaleFactor;
                                         ...
                                         intersectWithStage:Boolean, resultRect:Rectangle):void
        {
            ...
            if (object == stage || object == Catbird.current.root)
        ...
        /** @private */
        catbird_internal function compile(object:DisplayObject):QuadBatch
        {
