...
package org.catbird.text
{
    ...
    import org.catbird.display.DisplayObjectContainer;
    ...
    public class TextField extends DisplayObjectContainer
    {
        ...
        {
            var fonts:Dictionary = Catbird.current.contextData[BITMAP_FONT_DATA_NAME] as Dictionary;
            
            if (fonts == null)
            {
                fonts = new Dictionary();
                Catbird.current.contextData[BITMAP_FONT_DATA_NAME] = fonts;
            }
