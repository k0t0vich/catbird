...
package org.catbird.display
{
    ...
    [Event(name="resize", type="org.catbird.events.ResizeEvent")]
    
    /** Dispatched when a key on the keyboard is released. */
    [Event(name="keyUp", type="org.catbird.events.KeyboardEvent")]
    
    /** Dispatched when a key on the keyboard is pressed. */
    [Event(name="keyDown", type="org.catbird.events.KeyboardEvent")]
