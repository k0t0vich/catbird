...
package org.catbird.display
{
    ...
    import org.catbird.core.RenderSupport;
    import org.catbird.core.Catbird;
    import org.catbird.core.catbird_internal;
    import org.catbird.errors.MissingContextError;
    import org.catbird.events.Event;
    import org.catbird.filters.FragmentFilter;
    import org.catbird.filters.FragmentFilterMode;
    import org.catbird.textures.Texture;
    import org.catbird.textures.TextureSmoothing;
    import org.catbird.utils.MatrixUtil;
    import org.catbird.utils.VertexData;
    ...
    public class QuadBatch extends DisplayObject
    {
        ...
        public function QuadBatch()
        {
            ...
            Catbird.current.stage3D.addEventListener(Event.CONTEXT3D_CREATE, 
        ...
        {
            Catbird.current.stage3D.removeEventListener(Event.CONTEXT3D_CREATE, onContextCreated);
        ...
        private function createBuffers():void
        {
            ...
            var context:Context3D = Catbird.context;
                                     ...
                                     blendMode:String=null):void
        {
            ...
            context.setProgram(Catbird.current.getProgram(programName));
        ...
        {
            var target:Catbird = Catbird.current;
